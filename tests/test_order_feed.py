...
class TestOrderFeed:
    ...
    def test_pen_modal_window_with_order_info(self, setup_driver, create_and_delete_user):
    ...
    def test_appearance_order_in_order_feed(self, setup_driver, create_and_delete_user):
        driver = AutorizationMethod(setup_driver)
        driver.autorization_by_user()
        driver = MainPage(setup_driver)
    ...
    def test_appearance_order_in_progress(self, setup_driver, create_and_delete_user):
        driver = AutorizationMethod(setup_driver)
        driver.autorization_by_user()
        driver = MainPage(setup_driver)
        id_order = driver.creation_order()
    ...
    def test_increase_counter_order_all_time(self, setup_driver, create_and_delete_user):
        driver = MainPage(setup_driver)
        driver.click_to_element(LocatorsMainPage.ORDER_FEED_BUTTON)
    ...
    def test_increase_counter_order_today(self, setup_driver, create_and_delete_user):
        driver = MainPage(setup_driver)
        driver.click_to_element(LocatorsMainPage.ORDER_FEED_BUTTON)
